...
1. Say: "⚙️ Setting up your intern bot now..."
...
4. If `ok: true`:
   ...
   - Say:
```
✅ Your intern bot @{bot_username} is live!

Test it now — send it a message on Telegram.
...
🗣️ Ask you questions for free (Q&A in your voice)
